...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-40 flex shrink-0 h-fit border-b border-zinc-200/10 bg-zinc-400/10/80 backdrop-blur supports-[backdrop-filter]:bg-zinc-400/10 py-3">
